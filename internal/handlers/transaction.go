...
func (h *TransactionHandler) BorrowBook(c *gin.Context) {
	...
	middleware.Audit(c, "transactions", transaction.ID, "CREATE", nil, map[string]interface{}{"type": "borrow", "book": transaction.BookTitle, "student": transaction.StudentName, "copy_barcode": derefStr(transaction.CopyBarcode), "student_id": req.StudentID, "book_id": req.BookID})
...
func (h *TransactionHandler) ReturnBook(c *gin.Context) {
	...
	middleware.Audit(c, "transactions", int32(transactionID), "UPDATE", nil, map[string]interface{}{"type": "return", "book": transaction.BookTitle, "student": transaction.StudentName, "copy_barcode": derefStr(transaction.CopyBarcode)})
...
func (h *TransactionHandler) RenewBook(c *gin.Context) {
	...
	middleware.Audit(c, "transactions", int32(transactionID), "UPDATE", nil, map[string]interface{}{"type": "renew", "book": transaction.BookTitle, "student": transaction.StudentName, "copy_barcode": derefStr(transaction.CopyBarcode)})
...
func (h *TransactionHandler) CancelRenewal(c *gin.Context) {
	...
	middleware.Audit(c, "transactions", int32(transactionID), "UPDATE", nil, map[string]interface{}{"type": "cancel_renewal", "book": transaction.BookTitle, "student": transaction.StudentName, "copy_barcode": derefStr(transaction.CopyBarcode)})
...
func (h *TransactionHandler) CancelTransaction(c *gin.Context) {
	...
	middleware.Audit(c, "transactions", int32(transactionID), "UPDATE", nil, map[string]interface{}{"type": "cancel", "reason": req.Reason, "book": transaction.BookTitle, "student": transaction.StudentName, "copy_barcode": derefStr(transaction.CopyBarcode)})
...
func (h *TransactionHandler) MarkAsLost(c *gin.Context) {
	...
	middleware.Audit(c, "transactions", int32(transactionID), "STATUS_CHANGE", nil, map[string]interface{}{"status": "lost", "reason": req.Reason, "book": transaction.BookTitle, "student": transaction.StudentName, "copy_barcode": derefStr(transaction.CopyBarcode)})
...
func (h *TransactionHandler) MarkAsFound(c *gin.Context) {
	...
	middleware.Audit(c, "transactions", int32(transactionID), "STATUS_CHANGE", map[string]interface{}{"status": "lost"}, map[string]interface{}{"status": "found", "reason": req.Reason, "book": transaction.BookTitle, "student": transaction.StudentName, "copy_barcode": derefStr(transaction.CopyBarcode)})
...
func (h *TransactionHandler) BorrowByBarcode(c *gin.Context) {
	...
	middleware.Audit(c, "transactions", transaction.ID, "CREATE", nil, map[string]interface{}{"type": "borrow_by_barcode", "barcode": req.Barcode, "book": transaction.BookTitle, "student": transaction.StudentName, "copy_barcode": derefStr(transaction.CopyBarcode)})
...
func (h *TransactionHandler) ReturnByBarcode(c *gin.Context) {
	...
	middleware.Audit(c, "transactions", transaction.ID, "UPDATE", nil, map[string]interface{}{"type": "return_by_barcode", "barcode": req.Barcode, "book": transaction.BookTitle, "student": transaction.StudentName, "copy_barcode": derefStr(transaction.CopyBarcode)})
